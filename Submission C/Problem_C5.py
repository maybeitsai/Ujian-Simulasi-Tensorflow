...
def solution_C5():
    ...
    early_stop = tf.keras.callbacks.EarlyStopping(monitor='val_mae', patience=10, verbose=2, restore_best_weights=True)
    reduce_lr = tf.keras.callbacks.ReduceLROnPlateau(monitor='val_mae', factor=0.4, patience=4, min_lr=1e-6, verbose=2)
